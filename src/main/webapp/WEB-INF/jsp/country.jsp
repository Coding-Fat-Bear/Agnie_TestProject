<%-- 
    Document   : country
    Created on : 27 Jan, 2022, 1:13:06 PM
    Author     : agnie
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="mbar" >
                <div class="dropdown">
                    <button type="button" class="dropbtn"><%= request.getAttribute("CON")%></button>
                    <div id="drpcnt" class="dropdown-content">

                        <li><button type="button" id="cre" onclick="concre();" class="menu" ><%= request.getAttribute("EMC")%></button></li>
                        <li><button type="button" id="cha" onclick="concha();" class="menu" ><%= request.getAttribute("EMED")%></button></li>
                        <li><button type="button" id="dis" onclick="condis();" class="menu" ><%= request.getAttribute("EMDIS")%></button></li>
                        <li><button type="button" id="del" onclick="condel();" class="menu" ><%= request.getAttribute("EMDEL")%></button></li>
            ...
            <input type="text" style="width:53px;" maxlength="7" name="scrn" id="scrn" hidden>
                <ul class="opbut">
            <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:left;font-size:25px" formaction="insertcon" title="Create Country" ><i class="fa fa-save fa-2x"></i></button></li>
            <li><button type="submit" id="getbut" formaction="getcon" style="cursor: pointer;display:none;text-align:left;font-size:25px"  title="Get Country" ><i class="fas fa-glasses fa-2x"></i></button></li>
            <li><button type="submit" id="delbut" formaction="delcon" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Delete Country" ><i class="fa fa-trash fa-2x"></i></button></li>
            <li><button type="submit" id="chabut" formaction="updatecon" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Update Country" ><i class="fa fa-save fa-2x"></i></button></li>
                </ul>

            <ul>
             <li><label for="conId" style="width:80px" >Country ID</label><input maxlength="3" style="width:60px;" type="text" name="conId" id="conId" /></li>
             <li><label for="conName" style="width:80px" ><%= request.getAttribute("CON")%></label><input maxlength="30" style="width:150px;" type="text" name="conName" id="conName" /></li>
            </ul>
...
<script>
    document.getElementById("weblng").value = '<%= request.getAttribute("weblng") %>';
       ...
       if('<%= request.getAttribute("scrn")%>' === 'cha')
       {
         ...
         document.getElementById("conId").required = true;
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){   
         document.getElementById('conId').value = '<%= request.getAttribute("conId") %>';
         document.getElementById('conName').value = '<%= request.getAttribute("conName") %>';
     }
 </script>     
    </body>
</html>
