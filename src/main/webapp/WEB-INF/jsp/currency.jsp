<%-- 
    Document   : currency
    Created on : 10 Feb, 2022, 7:31:19 AM
    Author     : agnie
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="mbar" >
                <div class="dropdown">
                    <button type="button" class="dropbtn"><%= request.getAttribute("CUR")%></button>
                    <div id="drpcnt" class="dropdown-content">

                        <li><button type="button" id="cre" onclick="curcre();" class="menu" ><%= request.getAttribute("EMC")%></button></li>
                        <li><button type="button" id="cha" onclick="curcha();" class="menu" ><%= request.getAttribute("EMED")%></button></li>
                        <li><button type="button" id="dis" onclick="curdis();" class="menu" ><%= request.getAttribute("EMDIS")%></button></li>
                        <li><button type="button" id="del" onclick="curdel();" class="menu" ><%= request.getAttribute("EMDEL")%></button></li>
            ...
            <input type="text" style="width:53px;" maxlength="7" name="scrn" id="scrn" hidden>
                <ul class="opbut">
            <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:left;font-size:25px" formaction="insertcur" title="Create Currency" ><i class="fa fa-save"></i></button></li>
            <li><button type="submit" id="getbut" formaction="getcur" style="cursor: pointer;display:none;text-align:left;font-size:25px"  title="Get Currency" ><i class="fas fa-glasses"></i></button></li>
            <li><button type="submit" id="delbut" formaction="delcur" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Delete Currency" ><i class="fa fa-trash"></i></button></li>
            <li><button type="submit" id="chabut" formaction="updatecur" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Update Currency" ><i class="fa fa-save"></i></button></li>
            <li><button type="submit" id="bck" formaction="back17" style="cursor: pointer;display:none;text-align:left;font-size:25px"> <i class="fa fa-hand-o-left"></i></button></li> 
                </ul>

            <ul>
             <li><label for="curId" style="width:120px" >Currency ID</label><input maxlength="5" style="width:60px;" type="text" name="curId" id="curId" /></li>
             <li><label for="curName" style="width:120px" ><%= request.getAttribute("CUR")%></label><input maxlength="60" style="width:230px;" type="text" name="curName" id="curName" /></li>
            </ul>
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){   
         ...
         document.getElementById('curName').value = '<%= request.getAttribute("curName") %>';
     }
 </script>     
    </body>
</html>
