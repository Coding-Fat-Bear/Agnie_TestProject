	...
	<h1><a href="index.htm">
      ...
      <div id="frm" class="form1">
            <form action="login2"  method="post">
                <!--<pre>-->
                    ...
                    <li><input id='uname' placeholder="enter username"   type="text"  name="uname" ></li>                    
                    <lable for="pass">Password:</lable>
                    <li><input id="pass" placeholder="enter password"  type="password" name="pass"></li>
                  
                    
                    <li><button type="submit" class="but" >Login</button></li>
                    <div>                        
                        <button type="button" onclick="usrcre()" class="but1">Create User</button>                        
                        <a href="#" style="float:right;margin-top:10px">New Password</a>
                    </div>
      ...
      <script>
            ...
            function usrcre(){
                ...
                window.location = '../mavenspring/usercre.jsp';
            }
        </script>
    </body>
</html>
