<%-- 
    Document   : role
    Created on : 8 Feb, 2022, 7:17:35 PM
    Author     : agnie
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="mbar" >
                <div class="dropdown">
                    <button type="button" class="dropbtn"><%= request.getAttribute("ROL")%></button>
                    <div id="drpcnt" class="dropdown-content">

                        <li><button type="button" id="cre" onclick="rolcre();" class="menu" ><%= request.getAttribute("EMC")%></button></li>
                        <li><button type="button" id="cha" onclick="rolcha();" class="menu" ><%= request.getAttribute("EMED")%></button></li>
                        <li><button type="button" id="dis" onclick="roldis();" class="menu" ><%= request.getAttribute("EMDIS")%></button></li>
                        <li><button type="button" id="del" onclick="roldel();" class="menu" ><%= request.getAttribute("EMDEL")%></button></li>
            ...
            <input type="text" style="width:53px;" maxlength="7" name="scrn" id="scrn" hidden>
                <ul class="opbut">
            <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:left;font-size:25px" formaction="insertrol" title="Create Role Master" ><i class="fa fa-save"></i></button></li>
            <li><button type="submit" id="getbut" formaction="getrol" style="cursor: pointer;display:none;text-align:left;font-size:25px"  title="Get Role Master" ><i class="fas fa-glasses"></i></button></li>
            <li><button type="submit" id="delbut" formaction="delrol" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Delete Role Master" ><i class="fa fa-trash"></i></button></li>
            <li><button type="submit" id="chabut" formaction="updaterol" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Update Role Master" ><i class="fa fa-save"></i></button></li>
            <li><button type="submit" id="bck" formaction="back15" style="cursor: pointer;display:none;text-align:left;font-size:25px"> <i class="fa fa-hand-o-left"></i></button></li> 
                </ul>

            <ul>
             <li><label for="rolId" style="width:120px" >Role Master ID</label><input maxlength="5" style="width:60px;" type="text" name="rolId" id="rolId" /></li>
             <li><label for="rolName" style="width:120px" ><%= request.getAttribute("ROL")%></label><input maxlength="60" style="width:230px;" type="text" name="rolName" id="rolName" /></li>
            </ul>
    ...
    document.getElementById("weblng").value = '<%= request.getAttribute("weblng") %>';
       ...
       if('<%= request.getAttribute("scrn")%>' === 'cha')
       {
        ...
        // document.getElementById("bizId").required = true;
         document.getElementById("rolName").disabled = false;
      }
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){   
         document.getElementById('rolId').value = '<%= request.getAttribute("rolId") %>';
         document.getElementById('rolName').value = '<%= request.getAttribute("rolName") %>';
     }
 </script>     
    </body>
</html>
