<%-- 
    Document   : bank
    Created on : 31 Jan, 2022, 8:23:12 PM
    Author     : agnie
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="mbar" >
                <div class="dropdown">
                    <button type="button" class="dropbtn"><%= request.getAttribute("BAN")%></button>
                    <div id="drpcnt" class="dropdown-content">

                        <li><button type="button" id="cre" onclick="bancre();" class="menu" ><%= request.getAttribute("EMC")%></button></li>
                        <li><button type="button" id="cha" onclick="bancha();" class="menu" ><%= request.getAttribute("EMED")%></button></li>
                        <li><button type="button" id="dis" onclick="bandis();" class="menu" ><%= request.getAttribute("EMDIS")%></button></li>
                        <li><button type="button" id="del" onclick="bandel();" class="menu" ><%= request.getAttribute("EMDEL")%></button></li>
            ...
            <input type="text" style="width:53px;" maxlength="7" name="scrn" id="scrn" hidden>
                <ul class="opbut">
            <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:left;font-size:25px" formaction="insertban" title="Create Bank" ><i class="fa fa-save fa-2x"></i></button></li>
            <li><button type="submit" id="getbut" formaction="getban" style="cursor: pointer;display:none;text-align:left;font-size:25px"  title="Get Bank" ><i class="fas fa-glasses fa-2x"></i></button></li>
            <li><button type="submit" id="delbut" formaction="delban" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Delete Bank" ><i class="fa fa-trash fa-2x"></i></button></li>
            <li><button type="submit" id="chabut" formaction="updateban" style="cursor: pointer;display:none;text-align:left;font-size:25px" title="Update Bank" ><i class="fa fa-save fa-2x"></i></button></li>
                </ul>

            <ul>
             <li><label for="banId" style="width:70px" >Bank ID</label><input maxlength="3" style="width:60px;" type="text" name="banId" id="banId" /></li>
             <li><label for="banName" style="width:70px" ><%= request.getAttribute("BAN")%></label><input maxlength="30" style="width:210px;" type="text" name="banName" id="banName" /></li>
            </ul>
...
<script>
    document.getElementById("weblng").value = '<%= request.getAttribute("weblng") %>';
       ...
       if('<%= request.getAttribute("scrn")%>' === 'cha')
       {
         ...
         document.getElementById("banId").required = true;
         document.getElementById("banName").disabled = false;
      }
       if('<%= request.getAttribute("scrn") %>' === 'dis')
       {
        // var BackgroundColor="LightGreen"; // what ever color you want
         ...
         document.getElementById("delbut").style.display = "none";
         document.getElementById("banId").required = true;
         document.getElementById("banName").disabled = true;
     }
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){   
         document.getElementById('banId').value = '<%= request.getAttribute("banId") %>';
         document.getElementById('banName').value = '<%= request.getAttribute("banName") %>';
     }
 </script>     
    </body>
</html>
