...
<!--	<h1><a href="index.htm">
    ...
    <div class="mbar" >
      <div class="dropdown">
                <button  class="dropbtn"><%= request.getAttribute("EMM") %></button>
...
<div id="hed" class="head" >
        ...
        <ul class="opbut">
            <li><button type="submit" id="getbut" formaction="getemp" style="cursor: pointer;background-color: Blue;color: white;border: none;border-radius:5px;display:none;text-align:center;font-size:20px"  title="Get Employee Data" >Get</button></li>
            ...
            <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:center;font-size:20px" formaction="insert" title="Create Employee" ><i class="fa fa-file"></i></button></li>
        </ul>
        <ul class="top">
            ...
            <li><label  for="actst" style="width:150px" ><%= request.getAttribute("ATST") %></label><input name="actst" style="width:10px" id="actst"></li>
...
<div id="BD1" class="tabcontent">
  ...
  <ul>
      ...
      <li><label  for="dob"><%= request.getAttribute("DOBRT") %></label><input type="text" onfocus="(this.type='date')" style="width:130px;" placeholder="MM/DD/YYYY" onchange="dob();"  name="dob" id="dob" /></li>
      ...
      <li><label for="actst"><%= request.getAttribute("ATSTDT") %></label><input width="120px" style="width:130px;" type="date" id="actstrt" name="actstrt" /></li>
      <li><label for="acten"><%= request.getAttribute("ATENDT") %></label><input width="120px" style="width:130px;" type="date" id="actend" name="actend" /></li>
  </ul>
...
<div id="ORGD" class="tabcontent">
  ...
  <ul>
      ...
      <li><label for="rank" ><%= request.getAttribute("EMRNK") %></label>
          ...
          <li><label for="role" ><%= request.getAttribute("EMROLE") %></label>
          <select maxlength="2" style="width:150px;text-transform:uppercase" type="text" id="role" name="role" >
              <option value=""></option>
              <%
                  try
                  {
                      Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
                      String qry5 = "select * from Role_Master";
                      con1 = DriverManager.getConnection("jdbc:mysql://agn.db.mysql.agnieindia.com:3306/agnieportal","db_user","AgnChennai@2021");
                      stm = con1.createStatement();
                      ResultSet rs5 = stm.executeQuery(qry5);
                      while(rs5.next())
                      {
                          %>
                          <option value="<%=rs5.getString("ROLEID") %>"><%=rs5.getString("ROLE_TEXT") %></option>
                          <%
                      }
                  }
                  catch(Exception ex){
...
<script>
    document.getElementById("weblng").value = '<%= request.getAttribute("weblng") %>';
       ...
       if('<%= request.getAttribute("scrn") %>' === 'cha'){
         ...
         document.getElementById('actst').disabled = false;         
     ...
     if('<%= request.getAttribute("scrn") %>' === 'dis'){
         ...
         document.getElementById('actst').disabled = true;
        ...
        if('<%= request.getAttribute("scrn") %>' === 'cre'){
         ...
         document.getElementById('actst').value = "";
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){
         ...
         document.getElementById('actst').value = '<%= request.getAttribute("actst") %>';
