<%-- 
    Document   : module
    Created on : 18 Jan, 2022, 8:39:50 AM
    Author     : agnie
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="mbar" >
                <div class="dropdown">
                    <button type="button" class="dropbtn"><%= request.getAttribute("MOD")%></button>
                    <div id="drpcnt" class="dropdown-content">

                        <li><button type="button" id="cre" onclick="modcre();" class="menu" ><%= request.getAttribute("EMC")%></button></li>
                        <li><button type="button" id="cha" onclick="modcha();" class="menu" ><%= request.getAttribute("EMED")%></button></li>
                        <li><button type="button" id="dis" onclick="moddis();" class="menu" ><%= request.getAttribute("EMDIS")%></button></li>
            ...
            <input type="text" style="width:53px;" maxlength="7" name="scrn" id="scrn" hidden>
                <ul class="opbut">
                    ...
                    <li><button  type="submit" id="crebut" style="cursor: pointer;display:block;text-align:center;" formaction="insertmod" title="Create Module" ><i class="fa fa-file"></i></button></li>
                    <li><button type="submit" id="getbut" formaction="getmod" style="cursor: pointer;border: none;border-radius:5px;display:none;text-align:center;font-size:20px" title="Get Module Data" ><i class="fa fa-glasses"></i></button></li>
                    <li><button type="submit" id="chabut" formaction="updatemod" style="cursor: pointer;display:none;text-align:center;font-size:20px" title="Update Module" ><i class="fa fa-save"></i></button></li> 
                    <li><button type="submit" id="delbut" formaction="delmod" style="cursor: pointer;display:none;text-align:center;font-size:20px" title="Delete Module" ><i class="fa fa-trash"></i></button></li> 

                </ul>

                <ul>
                    <li><label for="modId">Module ID</label><input maxlength="4" style="width:60px;" type="text" name="modId" id="modId" /></li>
                    <li><label for="modName"><%= request.getAttribute("MOD")%></label><input maxlength="30" style="width:226px;" type="text" name="modName" id="modName" /></li>
                </ul>
...
<script>
    document.getElementById("weblng").value = '<%= request.getAttribute("weblng") %>';
       ...
       if('<%= request.getAttribute("scrn")%>' === 'cha')
       {
         ...
         document.getElementById("modId").required = true;
...
//     During Get operation got data from backend and pass to display fields
     ...
     if(<%= request.getAttribute("getnm") %> === 2){   
         document.getElementById('modId').value = '<%= request.getAttribute("modId") %>';
         document.getElementById('modName').value = '<%= request.getAttribute("modName") %>';
     }
 </script>     
    </body>
</html>
